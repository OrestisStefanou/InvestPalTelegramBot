...
class Database(ABC):
    @abstractmethod
    def get_user_by_telegram_user_id(self, telegram_user_id: str) -> Optional[TelegramUserDbModel]:
        pass

    @abstractmethod
    def set_onboarded_successfully(self, telegram_user_id: str, onboard_successfully: bool):
        pass

    @abstractmethod
    def add_new_user(self, telegram_user: TelegramUserDbModel):
        pass
...
class SqliteDB(Database):
    ...
    def add_new_user(self, telegram_user: TelegramUserDbModel):
        ...
        INSERT INTO telegram_users (
            telegram_user_id, agent_service_user_id, user_first_name, onboarded_successfully, created_at, updated_at
        ) VALUES (?, ?, ?, ?, ?, ?)
        """
        try:
